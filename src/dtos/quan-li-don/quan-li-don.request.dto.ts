import { z } from "zod";
import { FormItemSchema, UpdateStatusSchema } from "./quan-li-don";
...
/**
 * Schema and type for updating a form status
 */
export const UpdateFormStatusSchema = UpdateStatusSchema;

export type UpdateFormStatusRequest = z.infer<typeof UpdateFormStatusSchema>; 